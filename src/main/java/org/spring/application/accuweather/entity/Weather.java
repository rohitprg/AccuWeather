...
public class Weather {
	...
	@JsonCreator
	public Weather(
			@JsonProperty("LocalObservationDateTime") String localObservationDateTime,
	...
	public String toString() {
		return "Weather{" + "localObservationDateTime='"
				+ localObservationDateTime + '\'' + ", epochTime='" + epochTime
				+ '\'' + ", weatherText='" + weatherText + '\''
				+ ", temperatureC='" + temperatureC + '\'' + ", temperatureF='"
				+ temperatureF + '\'' + '}';
	}
}